...
- **Debug/Release Package Separation (2026-04-15)** - Debug builds now use `com.oasis.debug` package name, release builds use `com.oasis.app`. This prevents debug and release APKs from overwriting each other on the same device

...
class _AcrylicState extends State<Acrylic> {
  ...
  Widget build(BuildContext context) {
    ...
    final windowFocused = FluentTheme.of(context).windowFocused;
...
class _AcrylicGuts extends StatelessWidget {
  ...
  const _AcrylicGuts({required this.child, required this.windowFocused});
  ...
  Widget build(BuildContext context) {
    ...
    final disabled = DisableAcrylic.of(context) != null || !windowFocused;

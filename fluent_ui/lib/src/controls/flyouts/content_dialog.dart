  ...
  factory ContentDialogThemeData.standard(FluentThemeData theme) {
    return ContentDialogThemeData(
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(8), // Updated to 8px
        boxShadow: theme.shadows.elevation64, // Use standardized deep shadow
      ),
      padding: const EdgeInsetsDirectional.all(20),
      titlePadding: const EdgeInsetsDirectional.only(bottom: 12),
      actionsSpacing: 10,
      actionsDecoration: BoxDecoration(
        color: theme.micaAltBackgroundColor, // Use Mica Alt for actions area

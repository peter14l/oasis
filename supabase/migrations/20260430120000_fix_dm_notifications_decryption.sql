-- Migration: Add metadata column to notifications and update send_message_v3
-- This ensures DM notifications carry E2EE metadata for client-side decryption.

-- 1. Add metadata column to notifications table if it doesn't exist
DO $$ 
BEGIN
...
-- 2. Update send_message_v3 to populate metadata for DM notifications

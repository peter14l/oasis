-- Migration to cleanup overloaded functions and establish the final send_message_v2 signature
-- This solves the PGRST203 "Multiple Choices" error by removing previous overloads.

-- 1. Drop all previous versions of the function
-- Version from 20260421000000 (15 params)
...
-- Version from 20260421000004 (16 params)
...
-- Final Version from 20260421000005 (23 params)
...
-- 2. Create the FINAL version with all features and correct UUID generation

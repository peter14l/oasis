-- Ensure UUID extension is enabled (in case uuid_generate_v4 is needed elsewhere)
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Update send_message_v2 to support Whisper Mode, full metadata, and use a more reliable UUID function
...
AS $$
DECLARE
    -- Using gen_random_uuid() as it is built-in and avoids extension dependency issues

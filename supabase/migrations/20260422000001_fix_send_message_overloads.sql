-- Migration: Fix send_message_v2 Overloads
-- Description: Drops all existing overloads of send_message_v2 to resolve "Multiple Choices" RPC errors.

-- 1. Drop all existing overloads of send_message_v2
DO $$ 
DECLARE 
    r RECORD;
BEGIN
...
-- 2. Recreate the clean version (v2 without call_id)

-- Migration: Create send_message_v3
-- Description: Recreates the send message function from scratch to avoid any column cache issues and drops the old v2 versions.

-- 1. Drop existing send_message_v2 overloads to clean up the database
DO $$ 
DECLARE 
    r RECORD;
BEGIN

-- Migration: Fix send_message_v3 returned JSON fields
-- Purpose: Include voice_duration, encrypted_keys, iv, share_data, location_data,
--          signal_message_type, signal_sender_content, and media_view_mode in the returned JSON
--          so caller does not lose media & encryption metadata.
...
-- 2. Recreate send_message_v3 with full returned fields in JSON

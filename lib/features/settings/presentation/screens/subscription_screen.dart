              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    _buildMatrixRow(context, 'Time Capsules', '2 Active', 'Unlimited'),
                    _buildMatrixRow(context, 'Canvases & Circles', '2 Each', 'Unlimited'),
                    _buildMatrixRow(context, 'Creator Analytics', '7 Days', '90 Days + Insights'),
                    _buildMatrixRow(context, 'Wellness Reports', 'None', 'Weekly Reports'),
                    _buildMatrixRow(context, 'Focus & Wind-down', 'Basic', 'Custom & Advanced'),
                    _buildMatrixRow(context, 'Large File Sharing', 'No', 'Up to 2GB+'),
                    _buildMatrixRow(context, 'Media Downloads', 'Own only', 'Full access', isLast: true),
                  ],
                ),
              ),

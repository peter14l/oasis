...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'userId')  String userId,  String username, @JsonKey(name: 'userAvatar')  String userAvatar,  String? content,  String? imageUrl, @JsonKey(name: 'thumbnail_url')  String? thumbnailUrl, @JsonKey(name: 'dominant_color')  String? dominantColor, @JsonKey(name: 'media_urls')  List<String> mediaUrls, @JsonKey(name: 'media_types')  List<String> mediaTypes, @JsonKey(name: 'community_id')  String? communityId, @JsonKey(name: 'community_name')  String? communityName,  DateTime timestamp,  int likes,  int comments,  int shares, @JsonKey(name: 'isLiked')  bool isLiked, @JsonKey(name: 'isBookmarked')  bool isBookmarked, @JsonKey(name: 'isAd')  bool isAd, @JsonKey(name: 'isVerified')  bool isVerified,  String? mood)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Post() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'userId')  String userId,  String username, @JsonKey(name: 'userAvatar')  String userAvatar,  String? content,  String? imageUrl, @JsonKey(name: 'thumbnail_url')  String? thumbnailUrl, @JsonKey(name: 'dominant_color')  String? dominantColor, @JsonKey(name: 'media_urls')  List<String> mediaUrls, @JsonKey(name: 'media_types')  List<String> mediaTypes, @JsonKey(name: 'community_id')  String? communityId, @JsonKey(name: 'community_name')  String? communityName,  DateTime timestamp,  int likes,  int comments,  int shares, @JsonKey(name: 'isLiked')  bool isLiked, @JsonKey(name: 'isBookmarked')  bool isBookmarked, @JsonKey(name: 'isAd')  bool isAd, @JsonKey(name: 'isVerified')  bool isVerified,  String? mood)  $default,) {final _that = this;
switch (_that) {
case _Post():
return $default(_that.id,_that.userId,_that.username,_that.userAvatar,_that.content,_that.imageUrl,_that.thumbnailUrl,_that.dominantColor,_that.mediaUrls,_that.mediaTypes,_that.communityId,_that.communityName,_that.timestamp,_that.likes,_that.comments,_that.shares,_that.isLiked,_that.isBookmarked,_that.isAd,_that.isVerified,_that.mood);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'userId')  String userId,  String username, @JsonKey(name: 'userAvatar')  String userAvatar,  String? content,  String? imageUrl, @JsonKey(name: 'thumbnail_url')  String? thumbnailUrl, @JsonKey(name: 'dominant_color')  String? dominantColor, @JsonKey(name: 'media_urls')  List<String> mediaUrls, @JsonKey(name: 'media_types')  List<String> mediaTypes, @JsonKey(name: 'community_id')  String? communityId, @JsonKey(name: 'community_name')  String? communityName,  DateTime timestamp,  int likes,  int comments,  int shares, @JsonKey(name: 'isLiked')  bool isLiked, @JsonKey(name: 'isBookmarked')  bool isBookmarked, @JsonKey(name: 'isAd')  bool isAd, @JsonKey(name: 'isVerified')  bool isVerified,  String? mood)?  $default,) {final _that = this;
switch (_that) {
case _Post() when $default != null:
return $default(_that.id,_that.userId,_that.username,_that.userAvatar,_that.content,_that.imageUrl,_that.thumbnailUrl,_that.dominantColor,_that.mediaUrls,_that.mediaTypes,_that.communityId,_that.communityName,_that.timestamp,_that.likes,_that.comments,_that.shares,_that.isLiked,_that.isBookmarked,_that.isAd,_that.isVerified,_that.mood);case _:
  return null;

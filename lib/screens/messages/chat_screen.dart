...
import 'package:oasis/widgets/messages/invite_bubble.dart';
import 'package:oasis/widgets/gestures/gesture_widgets.dart';
...
class _ChatScreenState extends State<ChatScreen> with WidgetsBindingObserver {
  ...
  Widget _buildFloatingContainer({
    ...
    return ClipRRect(
      borderRadius:
          isCircular ? BorderRadius.circular(28) : BorderRadius.circular(20),
      child: BackdropFilter(
        filter: ImageFilter.blur(sigmaX: 20, sigmaY: 20),
        child: Container(
          width: isCircular ? 44 : null,
          height: isCircular ? 44 : null,
          padding: isCircular ? EdgeInsets.zero : const EdgeInsets.all(4),
          decoration: BoxDecoration(
            color:
                _backgroundUrl != null

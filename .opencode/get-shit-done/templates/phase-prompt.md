...
<!-- For checkpoint task examples and patterns, see @F:/oasis/.opencode/get-shit-done/references/checkpoints.md -->
...
See `F:/oasis/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `F:/oasis/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `F:/oasis/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.

...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = F:/oasis/.opencode
                  → checks F:/oasis/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = F:/oasis/.opencode/get-shit-done
                  → writes to F:/oasis/.opencode/get-shit-done/hooks/
...
@F:/oasis/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @F:/oasis/.opencode/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "F:/oasis/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "F:/oasis/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "F:/oasis/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```

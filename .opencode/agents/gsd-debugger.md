...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/oasis/.opencode
                  → checks D:/oasis/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/oasis/.opencode/get-shit-done
                  → writes to D:/oasis/.opencode/get-shit-done/hooks/
...
@D:/oasis/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/oasis/.opencode/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "D:/oasis/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "D:/oasis/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "D:/oasis/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```

...
<reference>
@D:/oasis/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/oasis/.opencode/get-shit-done/references/user-profiling.md` to load:

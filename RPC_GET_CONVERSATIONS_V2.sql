-- BULLETPROOF GET CONVERSATIONS RPC
-- This function fetches conversations along with their TRUE latest message
-- by querying the messages table directly for each conversation.
-- It avoids reliance on the potentially stale last_message_id in conversations table.
